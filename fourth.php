        ...
        <div class="container">
            <div class="row">
                <div class="card shadow wide-card">
                    ...
                    <!-- <p>Welcome to the famous five-minute iHRMS installation process! Just fill in the information
                        below and you'll be on your way to using the most extendable and powerful personal publishing
